...
export class ReviewService {
  private token =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2N2I5ZmJmMmY1YjhkNzc4OTUzOTFjYjQiLCJpYXQiOjE3NDIwOTY0NTl9.67xgRQENEP0VSOF3eh6ZC9XodwAeY-GKjQCMzKjd1BU';
  ...
  getCurrentUserReviews() {
    ...
    this.http
      .get<IReview[]>(API.review.getCurrentUserReviews, { headers })
      .subscribe((res) => {
