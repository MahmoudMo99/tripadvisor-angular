...
@Component({
  selector: 'app-search',
  imports: [NgClass, ReviewRateComponent, FormsModule, SearchCardComponent],
  templateUrl: './search.component.html',
  styleUrl: './search.component.scss'
})
export class SearchComponent {
  searchValue = new URL(window.location.href).searchParams.get('searchValue') || '';
  searchResult: any[] = [];
  ...
  searchPlaces() {
    this.searchService.searchPlaces(this.searchValue, 10, 1, this.placeType()).subscribe(result => {
